...
const MessageBubble = memo(function MessageBubble({ entry, onToggle, isLatest = false, messageRef, loadingStatus = "Panel is thinking...", status, statusTrail, onCopy, onDelete, onRegenerate, onContinueDebate, containerWidth, }) {
