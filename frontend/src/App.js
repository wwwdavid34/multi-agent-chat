...
export default function App() {
    ...
    if (!isAuthenticated) {
        return (_jsx("div", { className: "flex items-center justify-center min-h-screen bg-background", children: _jsxs("div", { className: "w-full max-w-md p-8 space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Multi-Agent Chat Panel" }), _jsx("p", { className: "mt-2 text-muted-foreground", children: "Sign in to access your conversations" })] }), _jsx(GoogleLoginButton, {})] }) }));
    }
    // Main chat interface
