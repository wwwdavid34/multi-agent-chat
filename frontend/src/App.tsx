  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-background">
      ...
      {sidebarVisible && (
                  ...
                  <AnimatePresence>
                    {threadMenuOpen === id && (
                      <motion.div
                        ...
                        className="absolute right-0 top-full mt-1 z-50 min-w-[140px] rounded-lg border border-border/60 bg-card shadow-lg py-1"
                      >
                        <button
                          type="button"
                          onClick={() => {
        ...
        {/* User menu, Settings and Theme toggle at bottom */}
