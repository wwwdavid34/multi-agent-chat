 ...
 */
export const MODES_BY_CATEGORY = {
 ...
 */
export function hasPresetPanelists(modeId) {
 ...
 */
export function getModeIconPath(icon) {
    const icons = {
        ...
        // Briefcase - business
        briefcase: "M20 7h-4V5c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2z M10 5h4v2h-4V5z",
        // Scale - decision/balance
        scale: "M12 3v18M3 7l9-4 9 4M3 7v4a9 9 0 0 0 9 0 9 9 0 0 0 9 0V7",
